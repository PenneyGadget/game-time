...
Tadpole.prototype.finalDetails = function() {
  let constraints = [this.top, this.right, this.bottom, this.left];
...
let findNeighbor = function(location, neighborRelativeLocation, canvasLayout) {
...
let updateNeighbors = function(self) {
