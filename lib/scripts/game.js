...
Game.prototype.startGame = function() {
  ...
  $('.game-div').click(function() {
    // $.fx.speeds.announcementsSlow = 1500;
    // $('start').fadeOut('announcementsSlow');
    // var text = "#1"
    // // $('level-announcements').appendChild(document.createTextNode(text));
    // $('level-announcements').fadeIn('announcementsSlow');
    // $('level-announcements').fadeOut('announcementsSlow');
    $.fx.speeds.canvasSlow = 3000;
    $('canvas').fadeIn('canvasSlow');
    self.playLevel(0);
  });
};
